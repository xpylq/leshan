...
public class CoapsClientEndpointFactory extends CoapClientEndpointFactory {
    ...
    public Endpoint createCoapEndpoint(InetAddress clientAddress, Configuration defaultConfiguration,
        ...
        dtlsConfigBuilder = setUpDtlsConfig(new InetSocketAddress(clientAddress, 0), serverInfo, dtlsConfigBuilder,
                defaultConfiguration, clientInitiatedOnly, trustStore);
